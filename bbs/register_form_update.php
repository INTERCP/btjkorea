...
// 추가
$chaptercode = isset($_POST['chaptercode'])            ? trim($_POST['chaptercode'])          : "";
$joblevel = isset($_POST['joblevel'])            ? trim($_POST['joblevel'])          : "";
$churchname = isset($_POST['churchname'])            ? trim($_POST['churchname'])          : "";
$pastorname = isset($_POST['pastorname'])            ? trim($_POST['pastorname'])          : "";
$chphone = isset($_POST['chphone'])            ? trim($_POST['chphone'])          : "";
$major = isset($_POST['major'])            ? trim($_POST['major'])          : "";
$talent = isset($_POST['talent'])            ? trim($_POST['talent'])          : "";
...
if ($w == '' || $w == 'u') {
    ...
    //if ($msg = reserve_mb_id($mb_id))       alert($msg, "", true, true);		// admin 사용 방지
